...
f_field[0]="dme"                                       # this is the Mean value version so I have to change the file name prefix
...
file_out="${output_dir}/AdriaClim_GoT_allscenario_median_${var}.csv"
...
if [[ -f $file_t ]]; then
	cdo -outputf,%2.4g,1  -selindexbox,$(( ind_x + 1 )),$(( ind_x + 1 )),$(( ind_y + 1 )),$(( ind_y + 1 ))  -selname,${var}_med  $file_t > $tmp_var  
else
