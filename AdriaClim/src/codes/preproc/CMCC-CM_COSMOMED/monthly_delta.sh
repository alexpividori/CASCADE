...
do
     ...
     #*************** Decades cycle ***************
     for year in 2025 2035 2045 2055 2065 2075 2085        # inferior limits of the decades considered
     do
...
#=========================================================================================================
                 ...
                 cdo -chname,${field},${field}_med    -setattribute,$field@standard_name="difference_between_${std_name}_monthly_medians"  -setyear,$year_middle  -ymonsub    \
...
#=================================================================================================================================================
                 ...
                 cdo -merge       min_${sub_scenario_file}_${year}01_${year_fin}12.nc  max_${sub_scenario_file}_${year}01_${year_fin}12.nc  \
