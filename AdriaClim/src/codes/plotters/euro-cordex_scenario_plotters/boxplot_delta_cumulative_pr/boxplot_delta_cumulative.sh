...
while IFS=";" read   point_n  year_middle
do
...
#======== pr =========
    ...
    echo "\"boxplot_delta_cumulative_csv.py\" will be launched right now for \"pr\" field"
    python  boxplot_delta_cumulative_csv.py  $point_n  $lat_p  $lon_p  $year_middle
