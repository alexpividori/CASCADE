...
for year_middle in 2015 $year_middle_in
do
...
done # end of decades cycle (2010/2020 and future decade)

python  csv_delta_annual_diff_pr.py  $point_n ${output_arc_dir}/histogram_tmp_data.txt ${output_arc_dir}/histogram_tmp_data_ref.txt  $RCP $year_in $year_fin $field
