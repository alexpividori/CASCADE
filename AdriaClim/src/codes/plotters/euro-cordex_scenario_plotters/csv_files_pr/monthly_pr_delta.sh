...
output_arc_dir="/lustre/arpa/AdriaClim/src/codes/plotters/euro-cordex_scenario_plotters/csv_files_pr"
...
python  csv_delta_diff_pr.py  $point_n ${output_arc_dir}/histogram_tmp_data.txt ${output_arc_dir}/histogram_tmp_data_ref.txt  $RCP $year_in $year_fin $month $field
