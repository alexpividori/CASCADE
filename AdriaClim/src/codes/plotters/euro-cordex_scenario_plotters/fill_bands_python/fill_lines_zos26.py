...
f1 = NetCDFFile( data_arc_dir+'/CNRM-CM5_CNRM-RCSM4/edmub_zos_MED-10_CNRM-CM5_rcp26_r8i1p1_CNRM-RCSM4_v1_mon_195001_210012.nc', mode='r')
...
t_start1 = datetime.datetime.strptime( "1950-01-01::00:00:00" , "%Y-%m-%d::%H:%M:%S")

for i in range( len(time_v1) ):
	time_delta = datetime.timedelta( days = time_v1[i]*30.42 )
...
plt.savefig( output_arc_dir+"/"+point_name+"/edmub_fillrcp26_zos_"+point_name+".png")
