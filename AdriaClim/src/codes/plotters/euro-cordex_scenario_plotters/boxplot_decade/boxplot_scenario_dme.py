...
output_arc_dir="/lustre/arpa/AdriaClim/public_html/EURO_CORDEX_analysis/SCENARIO/dme_boxplot_py"
...
for line in Lines:
	...
	#******* Reading netCDF file
	file_path=data_arc_dir+'/'+file_path[0]+"/postproc/monthly/"+file_info[0]+"_"+field_name+"_"+file_info[2]+"_"+file_info[3]+"_"+file_info[4]+"_"+file_info[5]+"_"+file_info[6]+"_"+file_info[7]+"_"+file_info[8]

	if ( not os.path.isfile( file_path ) ):
		continue

	f_nc     = NetCDFFile( file_path , mode='r')     # I have to insert the two subdirectories intermedian /postproc/monthly/
	var  = f_nc.variables[field_name+'_med'][:,lat_idx,lon_idx]
...
plt.title("Delta monthly median "+field_name+" scenario respect to 2010-2020 decade at point: "+point_name+"\n" , fontsize=30, fontdict={'family':'serif'} )
...
plt.savefig( output_arc_dir+"/"+point_name+"/dme_boxplot_"+field_name+"_"+point_name+".png" )
