...
#======== pr =========
    ...
    echo "\"ks_pr.py\" will be launched right now in $point_name, for an RCP: $RCP and for decade:$(( year_middle - 5 ))-$(( year_middle + 5 )) "
    python  ks_pr.py  $point_n  $lat_p  $lon_p  $RCP $year_middle 
