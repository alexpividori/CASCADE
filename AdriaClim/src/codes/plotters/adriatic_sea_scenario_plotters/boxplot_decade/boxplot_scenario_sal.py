...
file_sal = open("dme_initialization_file_sal.txt", 'r')
...
for line in Lines:
	...
	sal  = f_nc.variables['sos_med'][:,lat_idx,lon_idx]
...
plt.title("Delta monthly median salinity scenario respect to 2010-2020 decade at point: "+point_name+"\n" , fontsize=30, fontdict={'family':'serif'} )
plt.xlabel("Decade", fontsize=25 )
plt.ylabel("Sea surface delta median salinity [PSU]", fontsize=25 )
...
plt.savefig( output_arc_dir+"/"+point_name+"/dme_boxplot_sal_"+point_name+".png" )
