...
output_arc_dir="/lustre/arpa/AdriaClim/public_html/Med_CORDEX_analysis/SCENARIO/dme_boxplot_py"

file_temp = open("dme_initialization_file_temp.txt", 'r')
...
for line in Lines:
	...
	temp  = f_nc.variables['tos_med'][:,lat_idx,lon_idx]
...
plt.title("Delta monthly median temperatures scenario respect to 2010-2020 decade at point: "+point_name+"\n" , fontsize=30, fontdict={'family':'serif'} )
plt.xlabel("Decade", fontsize=25 )
plt.ylabel("Sea surface delta median temperature [°C]", fontsize=25 )
...
plt.savefig( output_arc_dir+"/"+point_name+"/dme_boxplot_temp_"+point_name+".png" )
