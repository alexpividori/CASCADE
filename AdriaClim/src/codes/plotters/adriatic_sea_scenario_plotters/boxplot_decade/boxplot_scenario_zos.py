...
file_zos = open("dme_initialization_file_zos.txt", 'r')
...
for line in Lines:
	...
	zos  = f_nc.variables['zos_med'][:,lat_idx,lon_idx]
...
plt.title("Delta monthly medians sea surface height scenario\nrespect to 2010-2020 decade at point: "+point_name+"\n" , fontsize=30, fontdict={'family':'serif'} )
plt.xlabel("Decade", fontsize=25 )
plt.ylabel("Sea surface delta median height [m]", fontsize=25 )
...
plt.savefig( output_arc_dir+"/"+point_name+"/dme_boxplot_zos_"+point_name+".png" )
