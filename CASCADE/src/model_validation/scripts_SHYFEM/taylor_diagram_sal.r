...
pdf(file = paste( output_dir ,"/taylor_diagram_SHY_S_" , gr , "_" , x_names[i] , ".pdf", sep="" ) )
...
legend( "topright",legend=paste( info_file[i,2] , "\U00F7" , info_file[i,3] , "m" , "SHYFEM Model" ),pch=19,col="red") # (lpos,lpos) is an (x,y) position
