...
pdf(file = paste( output_dir , "/boxplot_delta_S_" , gr , "_" , date_start , "_to_" , date_fin , ".pdf", sep="" ) )

if ( info_dim[1] == 6 ) {

boxplot( a_1[,8] - a_1[,7] , a_2[,8] - a_2[,7] , a_3[,8] - a_3[,7], a_4[,8] - a_4[,7] , a_5[,8] - a_5[,7] , a_6[,8] - a_6[,7] ,
        main=paste( "Shind-Smeas \n Data:", gr , " Period:",se_label ),
...
abline(h=(seq(-3,-1,1)), col="black", lty="dotted")
abline(h=(seq( 1, 7,1)), col="black", lty="dotted")

# mean_tot is the mean on the total periodi considered (2020-07 to 2021-07)

#if        ( gr=="group1" ){
#mean_tot=c( 1.30 , 0.71 , 0.12 , -0.16 )
#} else if ( gr=="group2" ){
#mean_tot=c( 0.31 , 0.08 , 0.05 )
#} else if ( gr=="group3" ){
#mean_tot=c( 0.81 , 0.67 , 0.43 , 0.19 , 0.16 , 0.16 )
#} else if ( gr=="tot"    ){
#mean_tot=c( 0.81 , 0.52 , 0.26 , 0.09 , 0.16 , 0.16 )
#} 
